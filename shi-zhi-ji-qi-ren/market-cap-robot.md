---
description: 全网最好的市值机器人，支持多种类型的Swap
---
...
**A:** 不会，夹子以及机器人利用的是抢跑区块的原理，很容易判断。而市值管理系统的所有买卖都是正常的交易，不会被识别为机器人。

### Q: 平台会拿到你的私钥吗？

**A:** 绝对不可能，你的私钥不会存储在平台上，所有操作都是基于前端执行的，请放心使用。
