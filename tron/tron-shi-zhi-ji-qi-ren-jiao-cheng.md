...
**金额：**&#x5728;拉盘模式下，这里的金额就是你所花费的TRX数量。在砸盘模式下，这里的金额就是你要出售的代币数量。

**全部：**&#x4E00;次性卖出所有代币，无视价格与滑点。

**随机：**&#x6839;据设置的金额范围，随机买入/卖出代币。

**固定：**&#x6309;照固定数额的TRX买入，或者按照固定数量的代币进行卖出。

**刷交易量：**&#x4E70;入概率就是执行买入操作的概率，反之卖出，买入金额为TRX的数量，卖出金额为代币的数量，卖出代币最小阈值是目标代币还剩多少就不会卖出只会买入。
