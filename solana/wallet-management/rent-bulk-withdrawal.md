...
**A:** 包括 SPL Token 账户、Token-2022 账户、空余额账户，只要不再使用都可以释放对应租金（价值币不可回收）。

### Q: 是否可以将所有 SOL 统一回收到一个地址？

**A:** 可以。你可以手动设定一个回收地址，所有释放的 SOL 将集中转入该地址，便于统一管理。

### Q: 导入的钱包没有 GAS（SOL）还能回收吗？

**A:** 可以。如果开启“代付Gas功能”，系统会使用你指定的钱包为其他钱包代付手续费，实现低成本批量操作。
