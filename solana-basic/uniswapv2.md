...
**A:** 它们是锁定在智能合约中以促进流动性的代币池。 通常，流动资金池的功能是允许交易者交易其数字资产，同时获得其资产持有量的回报。

### **Q: 什么是Uniswap V2？**

**A:** Uniswap V2是Uniswap V1的迭代和改进。 它包括以下功能；ERC20 / ERC20对 价格神谕 Flash掉期 核心/助手架构 技术改进 可持续发展之路 测试网和启动详细信息

### **Q: Uniswap V2和V1之间的区别？**

**A:** Uniswap V2只是对V1的改进。 Uniswap V1建立在以太坊区块链上，而V2是一个单独的区块链。取消掉期的V1要求流动性提供者为其添加到池中的每个代币在ETH中存入同等价值。 而Unswap V2正在实施ERC-20 / ERC-20流动性存款。

### **Q: 您如何计算资产池流动性？**

**A:** 用X \* Y = K确定池中的流动性。 X，Y和K分别代表ETH，ERC-20令牌和常量的值。 上面的等式代表了ETH / ERC-20代币的供求关系，并用它来平衡集合代币的价格。
